/* Copyright 2014 Google Inc. Licensed under the Apache License, Version 2.0 (the "License"); you
                ...
                new AnimatedMuzeiLogoView.OnStateChangeListener() {
                    ...
                    public void onStateChange(int state) {
                        if (state == AnimatedMuzeiLogoView.STATE_FILL_STARTED) {
                            ...
                            ObjectAnimator a1 = ObjectAnimator.ofFloat(mLogoView, View
                                    .TRANSLATION_Y, 0);
                            ObjectAnimator a2 = ObjectAnimator.ofFloat(mSubtitleView, View
                                    .TRANSLATION_Y, 0);
                            ObjectAnimator a3 = ObjectAnimator.ofFloat(mSubtitleView, View.ALPHA,
                                    1);
